...
public class PacketConstants {
	...
	public static final int CLEAR_INVENTORY_OPCODE = 223;
	...
	static {
		...
		PACKETS[DROP_TABLE_NPC_OPCODE] = new NPCOptionPacketListener();
		...
		PACKETS[CLEAR_INVENTORY_OPCODE] = new ClearInventoryPacketListener();
	}
}
