...
public enum FightType {
    ...
    SCYTHE_REAP(8056, 43, 0, BonusManager.ATTACK_SLASH, FightStyle.ACCURATE),
    SCYTHE_CHOP(8056, 43, 1, BonusManager.ATTACK_STAB, FightStyle.AGGRESSIVE),
    SCYTHE_JAB(8056, 43, 2, BonusManager.ATTACK_CRUSH, FightStyle.CONTROLLED),
    SCYTHE_BLOCK(8056, 43, 3, BonusManager.ATTACK_SLASH, FightStyle.DEFENSIVE),
