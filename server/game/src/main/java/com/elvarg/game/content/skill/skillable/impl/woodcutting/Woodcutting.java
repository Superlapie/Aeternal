...
public class Woodcutting extends DefaultSkillable {
    ...
    public static enum Tree {
        ...
        OAK(15, 38, 1521, new int[]{1281, 3037, 9734, 1751, 4533}, 14, 11, true),
        WILLOW(30, 68, 1519, new int[]{1308, 5551, 5552, 5553, 1750, 1758, 8488}, 15, 14, true),
        TEAK(35, 85, 6333, new int[]{9036}, 16, 16, true),
        DRAMEN(36, 88, 771, new int[]{1292}, 16, 17, true),
        MAPLE(45, 100, 1517, new int[]{1759, 4674, 8444}, 17, 18, true),
        MAHOGANY(50, 125, 6332, new int[]{9034}, 17, 20, true),
        YEW(60, 175, 1515, new int[]{1309, 1753, 8513}, 18, 28, true),
        MAGIC(75, 250, 1513, new int[]{1761, 8409}, 20, 40, true),
