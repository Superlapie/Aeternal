...
public class PrayerHandler {
    ...
    public enum PrayerData {
        THICK_SKIN(1, 1.6667, 5609, 83),
        BURST_OF_STRENGTH(4, 1.6667, 5610, 84),
        CLARITY_OF_THOUGHT(7, 1.6667, 5611, 85),
        SHARP_EYE(8, 1.6667, 19812, 700),
        MYSTIC_WILL(9, 1.6667, 19814, 701),
        ROCK_SKIN(10, 10, 5612, 86),
        SUPERHUMAN_STRENGTH(13, 10, 5613, 87),
        IMPROVED_REFLEXES(16, 10, 5614, 88),
        RAPID_RESTORE(19, 1.6667, 5615, 89),
        RAPID_HEAL(22, 3.3333, 5616, 90),
        PROTECT_ITEM(25, 3.3333, 5617, 91),
