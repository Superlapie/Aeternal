...
public final class Animation {
    ...
    private static final Set<Integer> ALLOWED_2446_OVERRIDES = new HashSet<>(Arrays.asList(
            ...
            11240, 11275, 11338, 11339, 11340, 11342, 11345, 11346, 11350, 11352, 11355, 11357, 11358, 11359,
            11364, 11365, 11366, 11390, 11391,
            11387, 11388, 11389, 11393, 11395,
            11396, 11397, 11398, 11399, 11400, 11401, 11402, 11403, 11404, 11405,
            11455, 11463, 11464, 11587,
    ...
    private static final Set<Integer> OPCODE14_USHORT_2446 = new HashSet<>(Arrays.asList(
            10954,
            11338, 11339, 11342, 11345, 11350, 11355, 11357, 11358, 11359, 11390
    ));
